...
pub const FORM_DIMENSIONS: &[&str] = &["layout", "labels", "label_positioning", "required_indicators", "input_sizing", "textarea_usage", "field_grouping", "validation", "errors", "error_display", "accessibility", "mobile", "cta", "trust", "performance", "progressive_disclosure", "input_types"];
...
pub const WEBSITE_ESSENTIAL_PAGES: &[&str] = &["homepage", "quick_install", "quick_start", "documentation", "comparison_pages", "llms_txt", "robots_sitemap", "terms", "privacy"];
...
pub fn get_next_task(
    ...
    match state.phase {
        ...
        ConvergencePhase::WebsiteConvergence => {
            ...
            // GEO dimensions (AI discoverability)
            for dim in GEO_DIMENSIONS { dims.push((*dim).into()); }
